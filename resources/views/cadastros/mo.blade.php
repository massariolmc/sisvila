                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="local" name="local" required>
                            @php
                            $locais = App\Local::all()->sortBy('local');
                            @endphp
...
<input type="hidden" name="autorizacao" value="mo">
<input type="hidden" name="status" value="0">
<input type="hidden" name="cep_func" value="0">
<input type="hidden" name="rua_func" value="0">
<input type="hidden" name="num_casa_func" value="0">
<input type="hidden" name="cidade_func" value="0">
<input type="hidden" name="bairro_func" value="0">
